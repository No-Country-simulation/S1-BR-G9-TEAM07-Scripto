...
@Schema(description = "Alteração de senha durante o período de soft-delete, sem reativar a conta")
public record SuspendedPasswordChangeDTO(
        @NotBlank
    ...
    public SuspendedPasswordChangeDTO {
