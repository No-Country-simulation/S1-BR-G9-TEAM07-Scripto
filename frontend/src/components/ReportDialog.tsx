      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <select id="shared-report-reason" value={reason} onChange={(event) => setReason(event.target.value as ReportReason)} className="min-h-10 w-full rounded-md border border-input bg-field px-3 dark:bg-background text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
