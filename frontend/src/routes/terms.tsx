  ...
  const content: Record<string, { introduction: string; sections: LegalSection[] }> = {
    "pt-BR": {
      ...
      sections: [
        ...
        { title: "5. Processamento e uso interno", paragraphs: ["Ao marcar o consentimento correspondente no envio, você autoriza o Scripto a processar e manter internamente uma cópia textual do conteúdo e os resultados de classificação e análise necessários para aprimorar os recursos inteligentes da plataforma.", "Essa autorização não transforma um documento privado em público. O conteúdo não será disponibilizado publicamente como base de treinamento; o uso descrito é interno e limitado às finalidades informadas pelo Scripto."] },
        { title: "6. Exclusão e período de recuperação", paragraphs: ["Ao solicitar a exclusão, sua conta é desativada e inicia um prazo de recuperação de 30 dias. Durante esse período, ela poderá ser reativada mediante validação das credenciais. Após o prazo, os dados pessoais seguem as regras de retenção e eliminação aplicáveis.", "Após a exclusão definitiva da conta, conteúdos previamente autorizados para uso interno e os respectivos resultados de análise podem ser mantidos de forma desvinculada dos seus dados pessoais, conforme o consentimento registrado e as regras aplicáveis."] },
    ...
    en: {
      ...
      sections: [
        ...
        { title: "5. Processing and internal use", paragraphs: ["When you select the relevant consent during submission, you authorize Scripto to internally process and retain a textual copy of the content and the classification and analysis results needed to improve the platform's intelligent features.", "This authorization does not make a private document public. The content will not be made publicly available as a training dataset; the described use is internal and limited to the purposes stated by Scripto."] },
        { title: "6. Deletion and recovery period", paragraphs: ["When you request deletion, your account is deactivated and a 30-day recovery period begins. During this period, it may be reactivated after credential validation. Afterward, personal data follows applicable retention and deletion rules.", "After permanent account deletion, content previously authorized for internal use and its analysis results may be retained without being linked to your personal data, according to the recorded consent and applicable rules."] },
