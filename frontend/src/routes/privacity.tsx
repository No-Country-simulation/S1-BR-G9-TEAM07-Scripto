  ...
  const content: Record<string, { introduction: string; sections: LegalSection[] }> = {
    "pt-BR": {
      ...
      sections: [
        ...
        { title: "4. Vetorização no PostgreSQL/pgvector", paragraphs: ["Quando houver consentimento explícito, o conteúdo pode ser convertido em representações vetoriais e armazenado no PostgreSQL/pgvector para busca semântica e treinamento interno do modelo do Scripto.", "Esses dados e vetores não são disponibilizados publicamente como conjunto de treinamento. O acesso é limitado ao ambiente interno e às finalidades informadas."] },
    ...
    en: {
      ...
      sections: [
        ...
        { title: "4. PostgreSQL/pgvector vectorization", paragraphs: ["With explicit consent, content may be converted into vector representations and stored in PostgreSQL/pgvector for semantic search and internal training of Scripto's model.", "This data and its vectors are not publicly distributed as a training dataset. Access is limited to the internal environment and the stated purposes."] },
